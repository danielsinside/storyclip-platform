 ...
 * Verificar si el problema es el directorio de trabajo o el comando FFmpeg
 */
...
async function diagnoseError234() {
  ...
  try {
    ...
    console.log('- Backend not receiving the correct data');
